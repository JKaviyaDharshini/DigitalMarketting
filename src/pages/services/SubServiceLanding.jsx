...
const SubServiceLanding = () => {
  const { subServiceId } = useParams();
  const data = subServicesData[subServiceId];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#06030a] text-white flex-col">
        <div className="text-center">
          ...
          <p className="mb-4">Debug ID: {subServiceId}</p>
          <p className="mb-8">Category: {useParams().category}</p>
      ...
      <div ref={processRef} className="py-32 relative">
        <div className="container">
          <div className="text-center mb-20">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">How we deliver exceptional results.</p>
          </div>
      ...
      <div className="container pb-32">
        <div className="p-12 md:p-20 rounded-3xl bg-gradient-to-br from-[var(--accent)]/20 to-[var(--grad-2)]/20 border border-white/10 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/70 max-w-xl mx-auto mb-10 text-lg">Let's discuss how our {data.title} service can transform your business.</p>
...
export default SubServiceLanding;
